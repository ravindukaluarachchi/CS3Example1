...
public class Items extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            File f = new File( getServletContext().getRealPath("/WEB-INF/data"),"items.json");
            RJSONHandler<Item> jh = new RJSONHandler<Item>("com.rav.bean.Item", f);
            List<Item> readList = jh.readList();
